<x-layout-web>
    ...
    <section class="py-3 py-md-5">
        <div class="container">
            <div class="mb-4">
                <span class="badge text-bg-dark mb-2">Pembayaran</span>
                <h1>{{ $title }}</h1>
                <hr>
            </div>
            <div class="row row-cols-1 row-cols-md-2 g-4">
                <div class="col">
                    <div class="card mb-4 border shadow-none">
                        <div class="card-body">
                            ...
                            <p class="mb-1"><strong>Tanggal Reservasi:</strong> {{ $reservasi->tanggal_reservasi }}
                            </p>
                ...
                <div class="col">
                    <form action="{{ route('user.bayar.proses', $reservasi->id) }}" method="POST"
                                ...
                                <div class="card border shadow-none">
                                    ...
                                    <div class="card-body">
                                        ...
                                        <p>Setelah melakukan pembayaran, harap konfirmasi melalui WhatsApp ke
                                            <strong>0812-3456-7890</strong> atau email ke
                                            <strong>admin@contoh.com</strong>.
                                        </p>
                                    </div>
                                </div>
                            </div>
