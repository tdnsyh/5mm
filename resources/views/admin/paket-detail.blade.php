<x-layout-admin>
    ...
    <div class="card">
        <div class="card-body">
            ...
            <div class="mt-3">
                <h5 class="card-title mb-3">{{ $paket->nama }}</h5>
                <p class="card-text">
                    <strong>Kategori:</strong> {{ $paket->kategori }} <br>
                    <strong>Type:</strong> {{ $paket->type }} <br>
                    <strong>Harga:</strong> Rp {{ number_format($paket->harga) }} <br>
                </p>
                ...
                <div class="d-flex flex-wrap">
                    @foreach ($paket->fotos as $foto)
                        <img src="{{ asset('storage/' . $foto->path) }}" class="me-2 mb-2 rounded" style="width: 250px;">
                    @endforeach
                </div>
